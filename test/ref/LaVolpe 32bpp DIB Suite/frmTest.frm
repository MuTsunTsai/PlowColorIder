...
Begin VB.Form frmTest 
   ...
   Begin VB.Menu mnuOtherOpts 
      ...
      Begin VB.Menu mnuSubOpts 
         ...
         End
         Begin VB.Menu mnuSaveAs 
            Caption         =   "Save As JPG (GDI+ required)"
            Index           =   2
         End
         Begin VB.Menu mnuSaveAs 
            Caption         =   "Save As TGA"
      ...
      End
      Begin VB.Menu mnuSubOpts 
         Caption         =   "Blend To Color (33% Blend)"
         Index           =   14
...
Private Sub mnuBlend_Click(Index As Integer)
    
    If mnuBlend(0).Tag = vbNullString Then
        mnuBlend(0).Tag = "shownMsg"
    ...
    Select Case Index
        ...
        Case 2: lColor = vbBlue
        Case 3: lColor = RGB(128, 128, 128)
    End Select
    
    cImage.BlendToColor lColor, 33
    RefreshImage
...
Private Sub mnuOpen_Click()
    ...
    Static CCDialog As New CCD
    Static sFile As String, sFileTitle As String
    
    If CCDialog.VBGetOpenFileName(sFile, sFileTitle, , , , , _
        "支援的影像格式（BMP、JPG、GIF、PNG）|*.bmp;*.jpg;*.jpeg;*.gif;*.png", , , _
        "開啟圖片檔案", "TXT", Me.hWnd, OFN_HIDEREADONLY) Then
   
        If cImage.LoadPicture_File(sFile, 256, 256) = True Then
...
Private Sub mnuSaveAs_Click(Index As Integer)
    ...
    Case 0: ' save as PNG using GDI+
        ...
        If Not sFile = vbNullString Then
            ...
            If cImage.SaveToFile_PNG(sFile, False) Then
    ...
    Case 2 ' save as jpg
        ...
        If Not sFile = vbNullString Then
        If cImage.SaveToFile_JPG(sFile, , False) = True Then
                MsgBox "JPG successfully created", vbInformation + vbOKOnly, "Success"
            Else
                MsgBox "JPG failed to be created", vbExclamation + vbOKOnly, "Failure"
            End If
        End If
    Case 3 ' save as tga options
    
    Case 5 ' save as rendered example
...
Private Sub mnuTGA_Click(Index As Integer)
    ...
    If Not sFile = vbNullString Then
        If cImage.SaveToFile_TGA(sFile, (Index = 0), True, , False) = True Then
            MsgBox "TGA successfully created", vbInformation + vbOKOnly, "Success"
        Else
            MsgBox "TGA failed to be created", vbExclamation + vbOKOnly, "Failure"
        End If
    End If
...
Private Sub Picture1_OLEDragDrop(Data As DataObject, Effect As Long, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Static I As Integer, T As String
    
    ' use class to return unicode filenames if applicable
    If cImage.GetDroppedFileNames(Data) = True Then

        T = ""
        For I = 1 To Len(Data.Files(1))
            T = T & Asc(Mid(Data.Files(1), I, 1)) & ","
        Next I
        Debug.Print T
